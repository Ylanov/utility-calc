...
# 35 дней — ТОЛЬКО последний месяц (текущий цикл подачи), чтобы не тянуть и
# не показывать в буфере подачи полугодовой давности. Раньше было 90 (3 мес).
# Меняется через analyzer_config: ключ "gsheets.max_age_days".
DEFAULT_GSHEETS_MAX_AGE_DAYS = 35
