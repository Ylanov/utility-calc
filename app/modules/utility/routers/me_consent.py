...
async def request_deletion(
    ...
    return {
        "status": "received",
        "message": (
            "Заявка принята. Срок рассмотрения — до 10 рабочих дней с даты получения "
            "(ст. 20 152-ФЗ; при отзыве согласия фактическое уничтожение ПД — до 30 дней "
            "согласно ст. 21). С вами свяжутся по контактам, указанным в личном кабинете."
        ),
    }
