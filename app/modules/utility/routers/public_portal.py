...
async def portal_state(
    ...
    # Долг/переплата ПО КВАРТИРЕ — опубликованные 1С-значения. Обновляются
    # АВТОМАТИЧЕСКИ раз в день после сбора 1С (onec_autopublish_task), а также
    # ручной кнопкой «Выгрузить». Сумма по всем жильцам комнаты (balance_209/205 —
