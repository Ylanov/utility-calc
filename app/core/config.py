...
class Settings(BaseSettings):
    ...
    # =========================================
    # 1С (БГУ) авто-подгрузка — белый список хостов
    # =========================================
    # Куда релею РАЗРЕШЕНО гнать браузер с расшифрованными кредами 1С. Защита от
    # подмены base_url (финансист/компрометация аккаунта не уведёт учётку на чужой
    # хост). Через запятую. По умолчанию — публикация 1С в корп-сети МЧС.
    ONEC_ALLOWED_HOSTS: str = "sv00web19.mchs.ru"
