...
// Логика секций живёт в их модулях (TariffsModule и др.); этот модуль
// отвечает только за раскрытие/сворачивание секций и синхронизацию
// с URL (?section=schedule). Ручной ввод показаний переехал в Реестр
// («➕ Ручной ввод», manual_entry.js, 2026-07-15).
